...
public class RegisterPageLayout extends BasePageLayout {
	...
	protected void onCreateContent(LinearLayout parent) {
		...
		params.setMargins(SizeHelper.fromPx(26), SizeHelper.fromPxWidth(32),
		...
		tv.setPadding(SizeHelper.fromPxWidth(14), 0,
		...
		LinearLayout.LayoutParams tvCountryParams = new LinearLayout.LayoutParams(
				LinearLayout.LayoutParams.WRAP_CONTENT,
				LinearLayout.LayoutParams.WRAP_CONTENT);
		...
		phoneParams.setMargins(SizeHelper.fromPxWidth(26),
				SizeHelper.fromPxWidth(30), SizeHelper.fromPxWidth(26), 0);
		phoneLayout.setLayoutParams(phoneParams);

		TextView countryNum = new TextView(context);
		countryNum.setId(Res.id.tv_country_num);
		LinearLayout.LayoutParams countryNumParams = new LinearLayout.LayoutParams(
				SizeHelper.fromPxWidth(104),
				LinearLayout.LayoutParams.MATCH_PARENT);
		countryNum.setLayoutParams(countryNumParams);
		countryNum.setGravity(Gravity.CENTER);
		countryNum.setTextColor(0xff353535);
		countryNum.setTextSize(TypedValue.COMPLEX_UNIT_PX,
				SizeHelper.fromPxWidth(25));
		...
		LinearLayout.LayoutParams writePhoneParams = new LinearLayout.LayoutParams(
				0, LinearLayout.LayoutParams.WRAP_CONTENT);
		writePhoneParams.gravity = Gravity.CENTER_VERTICAL;
		writePhoneParams.setMargins(SizeHelper.fromPxWidth(10), 0,
		...
		writePhone.setTextSize(TypedValue.COMPLEX_UNIT_PX,
				SizeHelper.fromPxWidth(25));
		...
		LinearLayout.LayoutParams imageParams = new LinearLayout.LayoutParams(
				SizeHelper.fromPxWidth(24), SizeHelper.fromPxWidth(24));
		...
		nextParams.setMargins(SizeHelper.fromPxWidth(26),
				SizeHelper.fromPxWidth(36), SizeHelper.fromPxWidth(26), 0);
		...
		nextBtn.setTextSize(TypedValue.COMPLEX_UNIT_PX,
				SizeHelper.fromPxWidth(25));
