...
public class SendMsgDialogLayout {
	...
	public static LinearLayout create(Context context) {
		...
		dialogTitle.setPadding(SizeHelper.fromPxWidth(20),
				SizeHelper.fromPxWidth(20), SizeHelper.fromPxWidth(20),
		...
		dialogTitle.setTextSize(TypedValue.COMPLEX_UNIT_PX,
		...
		dialogHint.setPadding(SizeHelper.fromPxWidth(18), 0,
				SizeHelper.fromPxWidth(18), 0);
		resid = R.getStringRes(context, "smssdk_make_sure_mobile_detail");
		dialogHint.setText(resid);
		dialogHint.setTextColor(0xffffffff);
		dialogHint.setTextSize(TypedValue.COMPLEX_UNIT_PX,
		...
		phone.setPadding(SizeHelper.fromPxWidth(18), 0,
				SizeHelper.fromPxWidth(18), 0);
		...
		LinearLayout.LayoutParams okParams = new LinearLayout.LayoutParams(0,
				SizeHelper.fromPxWidth(80), 1);
		...
		LinearLayout.LayoutParams line3Params = new LinearLayout.LayoutParams(
				SizeHelper.fromPxWidth(1),
				LinearLayout.LayoutParams.MATCH_PARENT);
