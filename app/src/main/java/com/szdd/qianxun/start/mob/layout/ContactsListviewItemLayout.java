...
public class ContactsListviewItemLayout {
	...
	public static RelativeLayout create(Context context) {
		...
		RelativeLayout.LayoutParams contactImageParams = new RelativeLayout.LayoutParams(
				SizeHelper.fromPxWidth(64), SizeHelper.fromPxWidth(64));
		...
		RelativeLayout.LayoutParams addParams = new RelativeLayout.LayoutParams(
				SizeHelper.fromPxWidth(92), SizeHelper.fromPxWidth(46));
