...
public class IdentifyNumPageLayout extends BasePageLayout {
	...
	protected void onCreateContent(LinearLayout parent) {
		...
		wrapperLayout.setPadding(SizeHelper.fromPxWidth(26), 0,
				SizeHelper.fromPxWidth(26), 0);
		parent.addView(wrapperLayout);

		TextView identifyNotify = new TextView(context);
		identifyNotify.setId(Res.id.tv_identify_notify);
		LinearLayout.LayoutParams identifyNotifyParams = new LinearLayout.LayoutParams(
				LinearLayout.LayoutParams.MATCH_PARENT,
		...
		identifyNotify.setTextSize(TypedValue.COMPLEX_UNIT_PX,
		...
		LinearLayout.LayoutParams inputBgParams = new LinearLayout.LayoutParams(
				LinearLayout.LayoutParams.MATCH_PARENT,
		...
		RelativeLayout.LayoutParams putIdentifyParams = new RelativeLayout.LayoutParams(
		...
		putIdentify.setTextSize(TypedValue.COMPLEX_UNIT_PX,
				SizeHelper.fromPxWidth(24));
		putIdentify.setInputType(InputType.TYPE_CLASS_NUMBER);
		inputBg.addView(putIdentify);

		RelativeLayout.LayoutParams clearImageParams = new RelativeLayout.LayoutParams(
				SizeHelper.fromPxWidth(34), SizeHelper.fromPxWidth(34));
		clearImageParams.addRule(RelativeLayout.CENTER_VERTICAL);
		clearImageParams.addRule(RelativeLayout.ALIGN_RIGHT,
				Res.id.et_put_identify);
		...
		RelativeLayout.LayoutParams soundParams = new RelativeLayout.LayoutParams(
		...
		soundBtn.setTextSize(TypedValue.COMPLEX_UNIT_PX,
		...
		LinearLayout.LayoutParams unreceiveParams = new LinearLayout.LayoutParams(
				LinearLayout.LayoutParams.MATCH_PARENT,
				LinearLayout.LayoutParams.WRAP_CONTENT);
		unreceiveParams.setMargins(0, SizeHelper.fromPxWidth(34), 0,
				SizeHelper.fromPxWidth(30));
		...
		unreceive.setTextSize(TypedValue.COMPLEX_UNIT_PX,
		...
		submitBtn.setTextSize(TypedValue.COMPLEX_UNIT_PX,
				SizeHelper.fromPxWidth(24));
		submitBtn.setPadding(SizeHelper.fromPxWidth(10), 0,
				SizeHelper.fromPxWidth(10), 0);
