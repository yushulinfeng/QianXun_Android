...
public class ContactDetailPageLayout extends BasePageLayout {
	...
	protected void onCreateContent(LinearLayout parent) {
		...
		wrapperParams.setMargins(SizeHelper.fromPxWidth(25),
				SizeHelper.fromPxWidth(30), SizeHelper.fromPxWidth(25), 0);
		wrapperLayout.setLayoutParams(wrapperParams);

		wrapperLayout.setBackgroundDrawable(DrawableHelper
				.createCornerBgNormal(context));
		...
		LinearLayout.LayoutParams imageParams = new LinearLayout.LayoutParams(
				SizeHelper.fromPxWidth(88), SizeHelper.fromPxWidth(88));
		...
		LinearLayout.LayoutParams innerParams = new LinearLayout.LayoutParams(
				LinearLayout.LayoutParams.MATCH_PARENT,
				LinearLayout.LayoutParams.WRAP_CONTENT);
		innerParams.setMargins(SizeHelper.fromPxWidth(4),
				SizeHelper.fromPxWidth(10), 0, SizeHelper.fromPxWidth(15));
		...
		contactName.setTextSize(TypedValue.COMPLEX_UNIT_PX,
				SizeHelper.fromPxWidth(24));
		innerLayout.addView(contactName);

		LinearLayout nestLayout = new LinearLayout(context);
		LinearLayout.LayoutParams nestParams = new LinearLayout.LayoutParams(
				LinearLayout.LayoutParams.MATCH_PARENT,
				LinearLayout.LayoutParams.WRAP_CONTENT);
		nestParams.setMargins(0, SizeHelper.fromPxWidth(10),
				SizeHelper.fromPxWidth(15), 0);
		...
		LinearLayout.LayoutParams tvPhoneParams = new LinearLayout.LayoutParams(
				LinearLayout.LayoutParams.WRAP_CONTENT,
				LinearLayout.LayoutParams.WRAP_CONTENT);
		...
		tvPhone.setTextSize(TypedValue.COMPLEX_UNIT_PX,
		...
		LinearLayout.LayoutParams contactPhoneParams = new LinearLayout.LayoutParams(
				LinearLayout.LayoutParams.WRAP_CONTENT,
				LinearLayout.LayoutParams.WRAP_CONTENT);
		...
		contactPhone.setTextSize(TypedValue.COMPLEX_UNIT_PX,
				SizeHelper.fromPxWidth(20));
		...
		LinearLayout.LayoutParams tvParams = new LinearLayout.LayoutParams(
				LinearLayout.LayoutParams.WRAP_CONTENT,
				LinearLayout.LayoutParams.WRAP_CONTENT);
		tvParams.setMargins(SizeHelper.fromPxWidth(26),
				SizeHelper.fromPxWidth(24), SizeHelper.fromPxWidth(26), 0);
		...
		inviteParams.setMargins(SizeHelper.fromPxWidth(26),
				SizeHelper.fromPxWidth(22), SizeHelper.fromPxWidth(26), 0);
		...
		inviteBtn.setTextSize(TypedValue.COMPLEX_UNIT_PX,
				SizeHelper.fromPxWidth(28));
