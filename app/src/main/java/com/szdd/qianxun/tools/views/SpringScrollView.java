 ...
 * 策略:获取ScrollView的子视图并添加到自定义的{@link SpringScrollLayout}滚动视图中
 * 将滚动视图添加到ScrollView作为子视图,所有的弹性滚动都由{@link SpringScrollLayout}来完成
 * 备注：不可指定padding。
 */
public class SpringScrollView extends ScrollView {
     ...
     * 自定义的弹性滚动视图
     */
    private SpringScrollLayout mContentLayout;
     ...
     * 功能描述:初始化滚动视图 <br>
     * <br>
     * <strong>策略:</strong> 获取ScrollView的子视图并添加到自定义的{@link SpringScrollLayout}滚动视图中
    ...
    private void initOverScrollLayout() {
        ...
        if (mContentLayout == null) {
            ...
            // 初始化弹性滚动视图
            mContentLayout = new SpringScrollLayout(getContext());
            // 移除ScrollView所有视图
            this.removeAllViews();
